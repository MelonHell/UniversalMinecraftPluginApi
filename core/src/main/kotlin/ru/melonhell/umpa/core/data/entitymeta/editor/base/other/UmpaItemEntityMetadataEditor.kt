...
interface UmpaItemEntityMetadataEditor : UmpaEntityMetadataEditor {
    ...
    override val metaType get(): Class<out UmpaEntityMetadata> = UmpaItemEntityMetadata::class.java
}