...
open class UmpaVexMetadataEditorImpl_v1_17_0 : UmpaVexMetadataEditor, UmpaMonsterMetadataEditorImpl_v1_17_0() {
    override fun readAttacking(raw: UmpaRawEntityMetadata) = raw.readFlag(16, 0)
    override fun writeAttacking(raw: UmpaRawEntityMetadata, value: Boolean?) = raw.writeFlag(16, 0, value)
}