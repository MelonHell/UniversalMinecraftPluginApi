...
open class UmpaOcelotMetadataEditorImpl_v1_17_0 : UmpaOcelotMetadataEditor, UmpaAnimalMetadataEditorImpl_v1_17_0() {
    override fun readTrusting(raw: UmpaRawEntityMetadata) = raw.readValue(17, Boolean::class.java)
    override fun writeTrusting(raw: UmpaRawEntityMetadata, value: Boolean?) = raw.writeValue(17, value, Boolean::class.java)
}