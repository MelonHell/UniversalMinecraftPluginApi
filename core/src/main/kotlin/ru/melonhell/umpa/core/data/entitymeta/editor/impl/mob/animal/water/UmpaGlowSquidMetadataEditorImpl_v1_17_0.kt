...
open class UmpaGlowSquidMetadataEditorImpl_v1_17_0 : UmpaGlowSquidMetadataEditor,
    ...
    override fun readDarkTicksRemaining(raw: UmpaRawEntityMetadata) = raw.readValue(16, Int::class.java)
    override fun writeDarkTicksRemaining(raw: UmpaRawEntityMetadata, value: Int?) = raw.writeValue(16, value, Int::class.java)
}