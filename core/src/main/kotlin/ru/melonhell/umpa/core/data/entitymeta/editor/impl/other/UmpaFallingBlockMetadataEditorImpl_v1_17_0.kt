...
open class UmpaFallingBlockMetadataEditorImpl_v1_17_0 : UmpaFallingBlockMetadataEditor,
    ...
    override fun readStartPos(raw: UmpaRawEntityMetadata) = raw.getValue(8, UmpaBlockPos::class.java)
    override fun writeStartPos(raw: UmpaRawEntityMetadata, value: UmpaBlockPos?) = raw.setValue(8, value)
}