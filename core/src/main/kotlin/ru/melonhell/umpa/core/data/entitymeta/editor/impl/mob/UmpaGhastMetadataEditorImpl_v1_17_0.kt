...
open class UmpaGhastMetadataEditorImpl_v1_17_0 : UmpaGhastMetadataEditor, UmpaFlyingMobMetadataEditorImpl_v1_17_0() {
    override fun readAttacking(raw: UmpaRawEntityMetadata) = raw.getValue(16, Boolean::class.java)
    override fun writeAttacking(raw: UmpaRawEntityMetadata, value: Boolean?) = raw.setValue(16, value)
}