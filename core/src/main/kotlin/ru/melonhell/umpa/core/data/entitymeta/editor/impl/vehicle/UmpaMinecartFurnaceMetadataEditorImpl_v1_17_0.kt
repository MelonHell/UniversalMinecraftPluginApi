...
open class UmpaMinecartFurnaceMetadataEditorImpl_v1_17_0 : UmpaMinecartFurnaceMetadataEditor,
    ...
    override fun readFuel(raw: UmpaRawEntityMetadata) = raw.getValue(14, Boolean::class.java)
    override fun writeFuel(raw: UmpaRawEntityMetadata, value: Boolean?) = raw.setValue(14, value)
}