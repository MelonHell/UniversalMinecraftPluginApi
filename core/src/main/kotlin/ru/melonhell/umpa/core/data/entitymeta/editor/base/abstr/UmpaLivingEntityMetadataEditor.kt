...
interface UmpaLivingEntityMetadataEditor : UmpaEntityMetadataEditor {
    ...
    fun readPotionEffectColor(raw: UmpaRawEntityMetadata): Optional<UmpaColor>?
    fun writePotionEffectColor(raw: UmpaRawEntityMetadata, value: Optional<UmpaColor>?)
    ...
    override val metaType get(): Class<out UmpaEntityMetadata> = UmpaLivingEntityMetadata::class.java
}