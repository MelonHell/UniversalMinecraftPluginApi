...
open class UmpaTropicalFishMetadataEditorImpl_v1_17_0 :
    ...
    override fun writePattern(raw: UmpaRawEntityMetadata, value: UmpaTropicalFishMetadata.Pattern?) = Unit // = raw.setValue(1, value)

    override fun readBodyColor(raw: UmpaRawEntityMetadata) = null // = raw.getValue(1, UmpaDyeColor::class.java)
    override fun writeBodyColor(raw: UmpaRawEntityMetadata, value: UmpaDyeColor?) = Unit // = raw.setValue(1, value)

    override fun readPatternColor(raw: UmpaRawEntityMetadata) = null // = raw.getValue(1, UmpaDyeColor::class.java)
    override fun writePatternColor(raw: UmpaRawEntityMetadata, value: UmpaDyeColor?) = Unit // = raw.setValue(1, value)
}