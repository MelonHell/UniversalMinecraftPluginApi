...
interface UmpaAbstractMinecartMetadataEditor : UmpaEntityMetadataEditor {
    ...
    override val metaType get(): Class<out UmpaEntityMetadata> = UmpaAbstractMinecartMetadata::class.java
}