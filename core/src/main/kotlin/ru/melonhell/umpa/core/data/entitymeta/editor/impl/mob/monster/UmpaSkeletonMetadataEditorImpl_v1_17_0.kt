...
open class UmpaSkeletonMetadataEditorImpl_v1_17_0 : UmpaSkeletonMetadataEditor,
    ...
    override fun readStrayConversion(raw: UmpaRawEntityMetadata) = raw.readValue(16, Boolean::class.java)
    override fun writeStrayConversion(raw: UmpaRawEntityMetadata, value: Boolean?) = raw.writeValue(16, value, Boolean::class.java)
}