...
open class UmpaItemFrameMetadataEditorImpl_v1_17_0 : UmpaItemFrameMetadataEditor,
    ...
    override fun readItemRotation(raw: UmpaRawEntityMetadata) = raw.getValue(9, Int::class.java)
    override fun writeItemRotation(raw: UmpaRawEntityMetadata, value: Int?) = raw.setValue(9, value)
}